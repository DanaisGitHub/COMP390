            ...
            <div className="lg:flex lg:items-center lg:-mx-10">
                <div className="lg:w-1/2 lg:mx-10">
                    ...
                    <form >
                        ...
                        <button type="submit" disabled className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            get in touch
                        </button>
                    </form>
                </div>
                ...
                <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                    < Image className=" object-scale-down mx-auto rounded-full shrink-0 w-96 h-96" src={image} alt=""></ Image>
                    ...
                    <div className="mt-6 space-y-8 md:mt-8">
                        ...
                        <p className="flex items-start -mx-2">
                            ...
                            <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">On Request</span>
                        </p>
                        ...
                        <p className="flex items-start -mx-2">
                            ...
                            <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">D.Zerai22@outlook.com</span>
                        </p>
                    </div>
